			...
			if (five_urlConnection.getResponseCode() == 200) {
				...
				if (apkVersion != null) {
					...
					if (object.getJSONArray("data") != null) {
						...
						String nativeVersion = new CurrentVersion().getVersionName(context);
						...
						if(interVersionArr[3].equals(nativeVersionArr[3])){
							String interVerNum = interVersionArr[0]+"."+interVersionArr[1]+"."+interVersionArr[2];
							String nativeVerNum = nativeVersionArr[0]+"."+nativeVersionArr[1]+"."+nativeVersionArr[2];
							if(!interVerNum.equals(nativeVerNum)){
								...
								apkInfo.setApkTime(mVersionRes.getString("time"));

								System.out.println("apkVersion VN:"
										+ mVersionVN.getString("VN") + "  url:"
										+ mVersionRes.getString("url") + "  time+"
