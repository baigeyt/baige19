...
public class InterWeb {
	...
	// 从本地获取设备密钥（再后台获取）
	private String SerialSecret() {
		db.creatDB_ID();
		mMacEntity = db.query_ID();
		db.closeDBMac();
		return mMacEntity.getDevices();
	}

	// 设备编码
	private String serialSecret = SerialSecret();

	// 获取访问令牌
	private String URL_AccessToken = web2 + " /index/getAccessToken";
	...
	private String URL_NOTICE = web2 + "/index/notice";
	...
	private String URL_Weather = web + "/index/weather?accesstoken=" + MAC
			+ "&longitude=" + MainActivity.longitude + "&latitude="
	...
	public String getURL_AccessToken() {
		return URL_AccessToken;
	}

	public void setURL_AccessToken(String uRL_AccessToken) {
		URL_AccessToken = uRL_AccessToken;
	}

	public String getSerialSecret() {
		return serialSecret;
	}

	public void setSerialSecret(String serialSecret) {
